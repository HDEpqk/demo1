...
func _ready():
	...
	lianpu_danger_fire.position.x = viewport_size.x/2
	lianpu_danger_fire.position.y = viewport_size.y/2-130
	
	lianpu_prop_decelerate.position.x = viewport_size.x/2+130
	lianpu_prop_decelerate.position.y = viewport_size.y/2
