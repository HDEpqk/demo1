...
func _ready():
	...
	var list=[
		{"video":LEVEL_3_0,"text":"能量计算：脸谱死亡后，上方能量条能量会根据脸谱的计算符号和能量值进行计算，如视频黄色脸谱碰到中心死亡后1-7变成-6，消灭了一个×3的绿色脸谱后-6×3变成-18"},
		{"video":LEVEL_3_1,"text":"上方能量值超过区间[-10,10]后，会触发20s倒计时。10s到20s，游戏得分倍数×2，最后10s游戏得分倍数×4，当倒计时结束时游戏结束。"}
	]
