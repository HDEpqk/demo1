extends Node
var UIBasePanel = load("res://scripts/ui/UIBasePanel.gd")
var EnergyCalibration=load("res://scripts/ui/EnergyCalibration.gd")
...
func update_control_data(control_name: String, data):
	if control_name in controls:
		...
		elif controls[control_name] is EnergyCalibration:
			controls[control_name].set_energy(data)
